...
interface ContenidoImprimibleProps {
  titulo?: string;
  parrafo?: string;
}

const ContenidoImprimible = forwardRef<
  HTMLDivElement,
  ContenidoImprimibleProps
>((props, ref) => {
  const { titulo, parrafo } = props;
  console.log("ContenidoImprimible props", props);
  console.log("ContenidoImprimible ref", ref);
  return (
    <div
...
const PaginaDeImpresion = () => {
  ...
  console.log("contenidoRefFFF", contenidoRef);
