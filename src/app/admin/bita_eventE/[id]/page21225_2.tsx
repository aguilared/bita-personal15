...
const EditForm: React.FC = () => {
  ...
  }); // Inicializado en 0 (o cualquier valor que no devuelva opciones al inicio)

  // 🟢 CORRECCIÓN CLAVE 1: Estado para el filtro del select anidado
  ...
  // 🟢 CORRECCIÓN CLAVE 3: Retención del valor del Select anidado (Hijo) // Este useEffect espera a que la lista de opciones (eventsId) se cargue completamente // y luego re-establece el valor inicial del evento para que se muestre en el Select.
