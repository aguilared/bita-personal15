  ...
  return (
    <main className="h-full">
      <QueryClientProvider client={queryClient}>
        ...
        <div className="container rounded sm:p-3 md:py-3 lg:px-3 py-3 px-4 bg-gray-200 dark:bg-black">
          <div className="mx-auto px-20 text-gray-600 text-2xl font-bold">
            Query List Animals{" "}
          </div>
